    ...
    >
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h1 className="font-serif text-5xl mb-4 text-brand-earth">Professional Local Guides</h1>
        ...
        <div className="flex flex-col md:flex-row gap-6 mb-12">
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-6 py-4 bg-white rounded-2xl border border-brand-earth/5 shadow-sm outline-none focus:border-brand-teal transition-all"
            />
          </div>
          ...
          <div className="flex items-center space-x-4">
            ...
            <select
              ...
              className="bg-white px-6 py-4 rounded-2xl border border-brand-earth/5 shadow-sm outline-none text-sm font-bold"
            >
              {locations.map((loc) => (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredGuides.map((guide) => (
            <motion.div
              ...
              className="glass-card rounded-[48px] overflow-hidden group border border-brand-earth/5 hover:border-brand-teal/30 transition-all hover:shadow-2xl"
            >
              <div className="p-8">
                ...
                <div className="pt-6 border-t border-brand-earth/5 flex items-center justify-between">
                  ...
                  <div className="flex space-x-3">
                    ...
                    <Link
                      ...
                      className="btn-primary !px-6 !py-3 !text-[11px] !rounded-2xl"
                    >
