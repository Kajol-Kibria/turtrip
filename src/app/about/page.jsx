    ...
    >
      <div className="max-w-4xl mx-auto">
        <header className="text-center mb-20">
          <h1 className="font-serif text-5xl md:text-6xl text-brand-earth mb-6">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-24">
          ...
          <div className="bg-brand-earth/5 p-8 rounded-[40px] border border-brand-earth/10 flex items-center justify-center">
        ...
        <section className="bg-brand-earth text-white p-12 md:p-16 rounded-[50px] shadow-2xl relative overflow-hidden">
