    ...
    >
      <div className="max-w-4xl mx-auto">
        <header className="text-center mb-20">
          <div className="w-20 h-20 bg-brand-teal/10 rounded-[30px] flex items-center justify-center mx-auto mb-8">
            <ShieldCheck className="w-10 h-10 text-brand-teal" />
          </div>
          <h1 className="font-serif text-5xl text-brand-earth mb-6">Trust is our foundation.</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20">
          <section className="bg-white p-10 rounded-[40px] shadow-xl border border-brand-earth/5">
            <div className="flex items-center space-x-4 mb-6">
              <div className="p-3 bg-brand-earth/5 rounded-2xl">
                <CheckCircle2 className="w-6 h-6 text-brand-earth" />
              </div>
              <h2 className="font-serif text-2xl">Verified Specialists</h2>
            </div>
          ...
          <section className="bg-white p-10 rounded-[40px] shadow-xl border border-brand-earth/5">
            <div className="flex items-center space-x-4 mb-6">
              ...
              <h2 className="font-serif text-2xl">Secure Payments</h2>
            </div>
            <p className="text-sm text-brand-earth/70 leading-relaxed mb-6">
          ...
          <section className="bg-white p-10 rounded-[40px] shadow-xl border border-brand-earth/5">
            <div className="flex items-center space-x-4 mb-6">
              ...
              <h2 className="font-serif text-2xl">Trip Tracking</h2>
            </div>
            <p className="text-sm text-brand-earth/70 leading-relaxed mb-6">
          ...
          <section className="bg-white p-10 rounded-[40px] shadow-xl border border-brand-earth/5">
            <div className="flex items-center space-x-4 mb-6">
              ...
              <h2 className="font-serif text-2xl">Physical Wellness</h2>
            </div>
            <p className="text-sm text-brand-earth/70 leading-relaxed mb-6">
        ...
        <div className="bg-brand-coral/10 p-10 rounded-[40px] border border-brand-coral/20">
          <div className="flex items-start space-x-6">
            <AlertTriangle className="w-8 h-8 text-brand-coral shrink-0 mt-1" />
            <div>
              <h3 className="font-serif text-2xl mb-2 text-brand-earth">Dispute Resolution</h3>
              <p className="text-sm text-brand-earth/70 leading-relaxed">
